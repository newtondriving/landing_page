  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        {/* Content */}
        <div className="mx-auto max-w-2xl mt-16 py-32 sm:py-48 lg:py-56 relative z-10">
          {/* Top Text */}
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div
              className="relative z-20 rounded-full px-3 py-1 text-sm text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20"
            >
